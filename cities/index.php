    ...
    <div class="row">
        <div class="col-6 table-responsive">
            <form action="./index.php" method="GET">
                <div class="row">
                    <div class="col-8">
                        <input type="text" name="searchTerm" class="form-control" value="<?=$searchTerm?>" placeholder="Pretraga gradova">
                    </div>
                    <div class="col-4">
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <?php
                        ...
                        if(!empty($searchTerm)){
                            $query .= " WHERE cities.name like '%$searchTerm%' OR countries.name like '%$searchTerm%' ";
                        }
